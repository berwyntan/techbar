const { laptops, computers, mobilePhones, printers, cameras } = require('./categoryIdSeed');
...
const productSeed = [
    ...
    },
    {
        ...
        price: 108,
        description: 'A4 Wi-Fi Monochrome Laser Printer with Wi-Fi & Wi-Fi Direct. Prints up to 20.0ppm (Black draft). Maximum printing resolution: 600 x 600 dpi. 1 Hi-Speed USB 2.0; 2.4GHz Wireless 802.11b/g/n with Bluetooth; Compatible Ink: 150A.',
        category: printers
    },
    {
